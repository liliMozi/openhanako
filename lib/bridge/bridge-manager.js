...
export class BridgeManager {
  ...
  startPlatform(platform, credentials, agentId) {
    ...
    try {
      ...
      this._platforms.set(key, { adapter, status: initialStatus, agentId: agentId || null });
      ...
      this._platforms.set(key, { adapter: null, status: "error", error: err.message, agentId: agentId || null });
